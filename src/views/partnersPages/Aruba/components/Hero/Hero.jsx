...
import hpe1 from '../../../../../svg/illustrations/technology-7997259_1280.jpg';
import hpe2 from '../../../../../svg/illustrations/switch-3297900_1280.jpg';
import hpe3 from '../../../../../svg/illustrations/aerial-1880873_1280.jpg';
...
const Hero = () => {
  ...
  const GridItemHeadlineBlock = () => (
    <Box>
      ...
      >
        HPE Aruba Networking, líder en tecnología de redes y movilidad.
      </Typography>
      <Box marginBottom={4}>
        <Typography
          variant="h6"
          ...
          data-aos={'fade-right'}
        >
          Se especializa en soluciones de redes inalámbricas y cableadas, así como en servicios de movilidad y seguridad para empresas y organizaciones.
        </Typography>
      </Box>
    </Box>
  );
