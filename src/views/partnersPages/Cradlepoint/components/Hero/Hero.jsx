...
import hpe1 from '../../../../../svg/illustrations/5gnrimg.webp';
import hpe2 from '../../../../../svg/illustrations/reduce-attk-surface-672x597-v3.png';
import hpe3 from '../../../../../svg/illustrations/private-wans-672x597-1.png';
...
const Hero = () => {
  ...
  const GridItemHeadlineBlock = () => (
    <Box>
      ...
      >
        Cradlepoint, conectividad en la nube de manera segura y confiable.
      </Typography>
      <Box marginBottom={4}>
        <Typography
          variant="h6"
          ...
          data-aos={'fade-right'}
        >
         Cradlepoint es una empresa que se especializa en soluciones de redes y conectividad, particularmente en el campo de la conectividad en la nube y las redes definidas por software.
        </Typography>
      </Box>
    </Box>
  );
