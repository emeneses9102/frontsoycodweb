    ...
    <Box>
      <Box marginBottom={2}>
        ...
        >
          ...
          <br />
        implementando una infraestructura de red flexible y segura
        </Box>
      </Box>
      <Box marginBottom={{ xs: 2, sm: 4 }}>
        <Box
          ...
          data-aos={isMd ? 'fade-right' : 'fade-up'}
        >
        Sus productos y servicios son especialmente útiles para sectores como la construcción, la atención médica, el transporte y la industria minorista, así como para cualquier empresa que necesite una infraestructura de red flexible y segura.
          <br />
        </Box>
      </Box>
    </Box>
