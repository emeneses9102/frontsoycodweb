...
import hpe2 from '../../../../../svg/illustrations/hacker-1944688_640.jpg';
import hpe1 from '../../../../../svg/illustrations/biometric-4503070_640.jpg';
import hpe3 from '../../../../../svg/illustrations/cyber-4610993_640.jpg';
...
const Hero = () => {
  ...
  const GridItemHeadlineBlock = () => (
    <Box>
      ...
      >
        Fortinet, líder en innovación y la investigación en ciberseguridad
      </Typography>
      <Box marginBottom={4}>
        <Typography
          variant="h6"
          ...
          data-aos={'fade-right'}
        >
          Fortinet se ha convertido en uno de los principales actores en el
          campo de la ciberseguridad y ofrece una amplia gama de productos y
          servicios diseñados para proteger las redes y sistemas de sus clientes
