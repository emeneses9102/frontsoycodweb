...
const Hero = () => {
  ...
  const GridItemHeadlineBlock = () => (
    <Box>
      ...
      >
       Honeywell, líder en tecnología e innovación 
      </Typography>
      <Box marginBottom={4}>
        <Typography
          variant="h6"
          ...
          data-aos={'fade-right'}
        >
         Encuentre soluciones de movilidad y automatización para almacenes, centros de distribución y retail entre otros, con soporte garantizado para no afectar su operación.
        </Typography>
      </Box>
    </Box>
  );
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6} xl={4}>
          ...
          >
            <Box
              component={'img'}
              src={'https://d117ffkp1c6hyc.cloudfront.net/images/centros-distribucion.jpeg'}
              alt="..."
              width={160}
              height={160}
            ...
            <Box
              ...
              width={200}
              height={200}
              src={'https://d117ffkp1c6hyc.cloudfront.net/images/logistica.jpeg'}
              alt="..."
              marginTop={'-8%'}
              zIndex={2}
              borderRadius={'100%'}
            ...
            <Box
              ...
              width={300}
              height={300}
              src={'https://d117ffkp1c6hyc.cloudfront.net/images/retail.jpeg'}
              alt="..."
              marginTop={'-20%'}
