...
import hpe2 from '../../../../../svg/illustrations/print-2797178_1280.jpg';
import hpe1 from '../../../../../svg/illustrations/machine-585262_1280.jpg';
import hpe3 from '../../../../../svg/illustrations/office-5169618_1280.jpg';
...
const Hero = () => {
  ...
  const GridItemHeadlineBlock = () => (
    <Box>
      ...
      >
        Hewlett Packard, líder en la industria de la tecnología de la información
      </Typography>
      <Box marginBottom={4}>
        <Typography
          variant="h6"
          ...
          data-aos={'fade-right'}
        >
         HP ha crecido para convertirse en una de las compañías de tecnología más grandes y reconocidas del mundo. A lo largo de su historia, HP ha estado involucrada en una amplia variedad de productos y servicios de tecnología.
        </Typography>
      </Box>
    </Box>
  );
