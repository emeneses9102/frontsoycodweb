    ...
    <Box>
      ...
      <Box marginBottom={{ xs: 2, sm: 4 }}>
        <Box
          ...
          data-aos={isMd ? 'fade-right' : 'fade-up'}
        >
          Hewlett-Packard, comúnmente conocida como HP, es una empresa de
          tecnología que ha sido un actor influyente en la industria de la
          tecnología de la información y la electrónica durante décadas.
          <br />
        </Box>
      </Box>
    </Box>
