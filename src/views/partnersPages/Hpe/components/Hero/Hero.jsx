...
import hpe1 from '../../../../../svg/illustrations/hpe1.jpg';
import hpe2 from '../../../../../svg/illustrations/hpe2.jpg';
import hpe3 from '../../../../../svg/illustrations/hpe3.jpg';
...
const Hero = () => {
  ...
  const GridItemHeadlineBlock = () => (
    <Box>
      ...
      >
        HPE, líder en la industria de TI híbrida
      </Typography>
      <Box marginBottom={4}>
        <Typography
          variant="h6"
          ...
          data-aos={'fade-right'}
        >
          Soluciones de infraestructura convergente y hiperconvergente que
          permiten a las empresas simplificar y optimizar sus centros de datos.
        </Typography>
      </Box>
    </Box>
  );
