...
import hpe1 from '../../../../../svg/illustrations/technology-1587673_640.jpg';
import hpe3 from '../../../../../svg/illustrations/computers-2653005_640.jpg';
import hpe2 from '../../../../../svg/illustrations/cyberspace-2784907_640.jpg';
...
const Hero = () => {
  ...
  const GridItemHeadlineBlock = () => (
    <Box>
      ...
      >
        Lenovo, importante competidor en la industria global de tecnología
      </Typography>
      <Box marginBottom={4}>
        <Typography
          variant="h6"
          ...
          data-aos={'fade-right'}
        >
          Lenovo es un actor importante en la industria global de tecnología,
          conocido por sus productos de calidad y su amplio rango de productos.
        </Typography>
      </Box>
    </Box>
  );
