...
import hpe1 from '../../../../../svg/illustrations/03-rdi-772x550-1.webp';
import hpe2 from '../../../../../svg/illustrations/pr-artificial-intelligence.webp';
import hpe3 from '../../../../../svg/illustrations/unify-data-across-the-globe.webp';
...
const Hero = () => {
  ...
  const GridItemHeadlineBlock = () => (
    <Box>
      ...
      >
        Redis Enterprise, la base de datos No SQL más rápida del mercado.
      </Typography>
      <Box marginBottom={4}>
        <Typography
          variant="h6"
          ...
          data-aos={'fade-right'}
        >
          Redis Enterprise está diseñado para ofrecer características avanzadas, escalabilidad y confiabilidad para empresas y organizaciones con necesidades de datos exigentes.
        </Typography>
      </Box>
    </Box>
  );
