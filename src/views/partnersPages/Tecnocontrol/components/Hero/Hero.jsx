...
import img1 from '../../../../../svg/illustrations/tecnocontrol-1.jpg';
import img2 from '../../../../../svg/illustrations/tecnocontrol-2.jpg';
import img3 from '../../../../../svg/illustrations/tecnocontrol-3.jpg';
//{'https://d117ffkp1c6hyc.cloudfront.net/images/centros-distribucion.jpeg'}
const Hero = () => {
  ...
  const GridItemHeadlineBlock = () => (
    <Box>
      ...
      >
       Tecnocontrol, mayor productividad para tu empresa
      </Typography>
      <Box marginBottom={4}>
        <Typography
          variant="h6"
          ...
          data-aos={'fade-right'}
        >
         Encuentre soluciones de telemetría, monitoreo e inteligencia artificial por CCTV.
        </Typography>
      </Box>
    </Box>
  );
