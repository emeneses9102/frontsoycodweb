...
import hpe2 from '../../../../../svg/illustrations/server-4393370_1280.jpg';
import hpe3 from '../../../../../svg/illustrations/skyscrapers-4168483_1280.jpg';
import hpe1 from '../../../../../svg/illustrations/stock-1863880_1280.jpg';
...
const Hero = () => {
  ...
  const GridItemHeadlineBlock = () => (
    <Box>
      ...
      >
       Veeam, líder en el mercado de copia de seguridad, recuperación y disponibilidad de datos
      </Typography>
      <Box marginBottom={4}>
        <Typography
          variant="h6"
          ...
          data-aos={'fade-right'}
        >
         Su enfoque principal es proporcionar herramientas y servicios que permitan a las organizaciones garantizar la disponibilidad continua de sus datos y aplicaciones, incluso en entornos complejos de TI.
        </Typography>
      </Box>
    </Box>
  );
