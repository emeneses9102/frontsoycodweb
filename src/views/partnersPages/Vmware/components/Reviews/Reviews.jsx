  ...
  const GridItemHeadlineBlock = () => (
    <Box>
      <Box marginBottom={2}>
        ...
        >
          Crea entornos de infraestructura de TI
          <br />
          virtualizados
        </Box>
      </Box>
      <Box marginBottom={{ xs: 2, sm: 4 }}>
        <Box
          ...
          data-aos={isMd ? 'fade-right' : 'fade-up'}
        >
          Optimiza recursos, mejorar la eficiencia operativa y reduce costos.
          Permitie la virtualización de recursos informáticos para mejorar la
          agilidad, la escalabilidad y la eficiencia.
          <br />
        </Box>
      </Box>
    </Box>
