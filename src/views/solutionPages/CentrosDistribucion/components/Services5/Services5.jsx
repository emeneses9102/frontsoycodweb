  ...
  return (
    <Box>
      ...
      <Grid container spacing={2}>
        {[
          {
            title: 'Soluciones de RFID para Hotelería',
            subtitle:
              '',
            icon: (
              <svg
          ...
          {
            title: 'Control de Acceso con tarjetas RFID	',
            subtitle:
              '',
            icon: (
              <svg
          ...
          {
            title: 'Tags de RIFD para acceso a servicios',
            subtitle:
              '',
            icon: (
              <svg
          ...
          {
            title: 'Impresoras de tarjetas RFID',
            subtitle:
              '',
            icon: (
              <svg
